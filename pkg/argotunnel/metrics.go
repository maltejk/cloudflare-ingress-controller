...
// from here https://github.com/cloudflare/cloudflared/blob/2019.4.1/origin/metrics.go
...
// from here https://github.com/cloudflare/cloudflared/blob/2019.4.1/origin/tunnelsforha.go
...
func EnableMetrics(updateFrequency time.Duration) {
	metricsConfig.setMetrics.Do(func() {
		metricsConfig.metrics = NewTunnelMetrics()
